...
$fetchProfile = $this->db->query("SELECT * FROM administrator WHERE admin_loginID ='{$_SESSION['adminName']}'");
$row = $fetchProfile->row();
...
<img src="<?php echo $row->admin_avatar; ?>" alt="" class="rounded-circle img-thumbnail">
</div>
<h5 class="mb-1"><?php echo $row->admin_name; ?></h5>
<p class="text-muted"><?php echo $row->admin_role; ?></p>

<div><i class="mdi mdi-wallet text-muted font-size-16 align-middle me-1"></i> <span class="align-middle">Balance : <b class="fw-semibold font-size-16">$6951.02</b></span></div>
</div>
...
<div>
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/small/img-4.jpg" alt="blog img" class="avatar-lg h-auto rounded">
</div>
</div>
...
<div class="flex-shrink-0 me-3">
<div>
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/small/img-3.jpg" alt="blog img" class="avatar-lg h-auto rounded">
</div>
</div>
<div class="flex-grow-1 overflow-hidden">
...
<div class="flex-shrink-0 me-3">
<div>
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/small/img-2.jpg" alt="blog img" class="avatar-lg h-auto rounded">
</div>
</div>
<div class="flex-grow-1 overflow-hidden">
...
<div class="flex-shrink-0 me-3">
<div>
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/small/img-9.jpg" alt="blog img" class="avatar-lg h-auto rounded">
</div>
</div>
<div class="flex-grow-1 overflow-hidden">
...
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/users/avatar-2.jpg" alt="" class="img-thumbnail rounded-circle">
</div>
<div class="flex-grow-1">
<div>
...
<div class="d-flex align-items-center">
<div class="avatar flex-shrink-0 me-3">
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/users/avatar-3.jpg" alt="" class="img-thumbnail rounded-circle">
</div>
<div class="flex-grow-1">
<div>
...
<div class="d-flex align-items-center">
<div class="avatar flex-shrink-0 me-3">
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/users/avatar-4.jpg" alt="" class="img-thumbnail rounded-circle">
</div>
<div class="flex-grow-1">
<div>
...
<div class="d-flex align-items-center">
<div class="avatar flex-shrink-0 me-3">
<img src="<?php echo base_url(); ?>modules/dashboard/assets/images/users/avatar-5.jpg" alt="" class="img-thumbnail rounded-circle">
</div>
<div class="flex-grow-1">
<div>
<h5 class="font-size-14 mb-1">Frontend Developer</h5>
