...
<form method="POST" action="<?php echo base_url('verify_interns'); ?>">
<div class="form-floating form-floating-custom mb-3">
<input type="text" class="form-control" id="input-name" placeholder="Enter Login ID" name="internsLoginID">
...
<div class="form-floating form-floating-custom mb-3">
<input type="email" class="form-control" id="input-username" placeholder="Enter Email" name="internsLoginEmail">
...
<div class="form-floating form-floating-custom mb-3">
<input type="password" class="form-control" id="floatingPassword" placeholder="Enter Password" name="internsPassword">
...
<div class="mt-3">
<button class="btn btn-info w-100" type="submit" name="internsLogin">Login</button>
</div>
</form><!-- end form -->
